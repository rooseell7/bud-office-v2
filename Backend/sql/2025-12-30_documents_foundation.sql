...
-- Використовуємо лапки для імен колонок, щоб збіг з TypeORM/schema-init (sourceType, sourceId).
...
-- document_events: лапки для збігу з schema-init ("documentId", "createdAt").
